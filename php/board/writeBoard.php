                    ...
                    <form action="saveBoard.php" name="boardWrite" method="post">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="text" name="boardTitle" id="boardTitle" class="title-text" required autofocus />
                            </div>
                            <div>
                                <label for="boardContent">내용</label>
                                <textarea name="boardContent" id="boardContent" class="title-text" rows="13" required></textarea>
                            </div>
                        </fieldset>
